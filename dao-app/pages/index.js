...
export default function Home() {
  ...
  const voteOnProposal = async (proposalId, _vote) => {
    try {
      ...
      console.error(error);
      window.alert("You successfully voted Nay");
    }
  };
  ...
  return (
    <div>
      ...
      <div className={styles.main}>
        <div>
          <h1 className={styles.title}>Welcome to Life Dao!</h1>
          <div className={styles.description}>Welcome to the DAO!</div>
          <div className={styles.description}>
            Your Sapa NFT Balance: {nftBalance}
            <br />
        ...
        <div>
          <img className={styles.image} src="./image.jpg" />
        </div>
      </div>

      <footer className={styles.footer}>
        Made with &#10084; by Sapa Developer forum
      </footer>
    </div>
  );
}
